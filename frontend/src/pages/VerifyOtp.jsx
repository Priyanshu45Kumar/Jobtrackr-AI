...
import { ShieldCheck, RefreshCw, Mail, ArrowRight, Sparkles } from "lucide-react";
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-white/8 overflow-hidden">
          ...
          <div className="px-8 py-6">
            ...
            {/* Success */}
            {success && (
              <div className="mb-4 bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-xs flex items-center gap-2">
                <ShieldCheck size={13} />
                {success}
              </div>
            )}
            ...
            <div className="flex items-center gap-3 my-4">
              ...
              <span className="text-xs text-slate-400">didn't get it?</span>
              <div className="flex-1 h-px bg-slate-100" />
            </div>
            ...
            <button
              ...
              disabled={resending}
              className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-100 disabled:opacity-60 transition-colors"
            >
